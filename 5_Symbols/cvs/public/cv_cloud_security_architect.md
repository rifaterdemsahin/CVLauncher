# RIFAT ERDEM SAHIN
## Cloud Security Architect | Technology Specialist
...
Senior Cloud Security Architect specializing in **enterprise technology solutions, automation, and system optimization**. Expert in designing and implementing scalable solutions supporting mission-critical business operations.

---

## CORE COMPETENCIES

⚙️ **Cloud Security Architect Expertise**
- Enterprise cloud security architect design and implementation
...
**Enterprise Cloud Security Architect Platform**
- **Challenge:** Implement scalable cloud security architect solutions for financial services environment
...
- **Challenge:** Scale cloud security architect capabilities for medical device and IoT environments
...
- **Challenge:** Modernize cloud security architect infrastructure for property management analytics
...
**Senior Cloud Security Architect / AI Solutions Architect** | January 2025 - Present  
*IBM | London, UK*
...
**Senior Cloud Security Architect / Technical Lead** | 2020 - 2025  
*Goldman Sachs, Ypsomed, Cushman & Wakefield*

- Led cloud security architect initiatives across finance, healthcare, and real estate sectors
...
**Cloud Security Architect** | 2016 - 2020  
...
**Immediate Availability** for cloud security architect roles
