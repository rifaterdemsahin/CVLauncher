# RIFAT ERDEM SAHIN
## Security Architect | Cybersecurity Architecture & Strategy Specialist
...
Senior Security Architect specializing in **security architecture design, threat modeling, and risk management**. Expert in building comprehensive security frameworks protecting enterprise assets and data.
...
**Enterprise Security Architect Platform**
- **Challenge:** Implement scalable security architect solutions for financial services environment
...
- **Challenge:** Scale security architect capabilities for medical device and IoT environments
...
- **Challenge:** Modernize security architect infrastructure for property management analytics
...
**Senior Security Architect / AI Solutions Architect** | January 2025 - Present  
*IBM | London, UK*
...
**Senior Security Architect / Technical Lead** | 2020 - 2025  
*Goldman Sachs, Ypsomed, Cushman & Wakefield*

- Led security architect initiatives across finance, healthcare, and real estate sectors
...
**Immediate Availability** for security architect roles
