# RIFAT ERDEM SAHIN
## Frontend Developer | UI/UX & Modern Web Specialist
...
Senior Frontend Developer specializing in **creating responsive, accessible, and high-performance user interfaces**. Deep expertise in React ecosystem, state management, and modern CSS architecture. Proven track record in translating complex design systems into pixel-perfect code and optimizing front-end performance for global scale.
...
**Senior Frontend Developer / AI Solutions Architect** | January 2025 - Present  
*IBM | London, UK*
...
**Senior Frontend Developer / Technical Lead** | 2020 - 2025  
*Goldman Sachs, Ypsomed, Cushman & Wakefield*

- Led frontend developer initiatives across finance, healthcare, and real estate sectors
...
**Immediate Availability** for frontend developer roles
