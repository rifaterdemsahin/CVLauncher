# RIFAT ERDEM SAHIN
## Full Stack Developer | End-to-End Web Application Specialist
...
- Cloud Infrastructure (AWS Lambda, Vercel, IBM Cloud, Docker)
...
### 🏆 2025 | IBM | London, UK
**Enterprise AI-Integrated Full Stack Transformation**
- **Challenge:** Modernize enterprise web applications by integrating AI capabilities and hybrid cloud infrastructure
- **Solution:** Developed a suite of AI-powered web applications using React and Node.js, integrated with IBM watsonx for intelligent data analysis
- **Impact:**
  - 35% reduction in data processing time through AI-driven frontend optimization
  - 40% improvement in user engagement via personalized AI-driven interfaces
  - Seamless deployment of micro-frontends on Red Hat OpenShift, enhancing scalability
- **Technologies:** React, Node.js, IBM watsonx, Red Hat OpenShift, GraphQL, GitHub Actions

### 🏆 2024 | SaaS Start-up | London
...
- **Technologies:** React, Node.js, Micro-frontends, Docker, AWS
...
### Frontend Stack
**Frameworks:** React, Next.js, Vue.js, AngularJS  
**Styling:** Tailwind CSS, SASS, Styled Components, Material UI  
**Tools:** Webpack, Vite, Babel, Jest, Storybook  

### Backend & Infrastructure
**Languages:** Node.js (TypeScript), Python (FastAPI/Django), Go  
**Databases:** PostgreSQL, MongoDB, Redis, Dataverse  
**Cloud:** AWS, Azure, IBM Cloud, Vercel, Netlify  
...
**Senior Full Stack Developer / AI Solutions Architect** | January 2025 - Present  
*IBM | London, UK*

- Developing complex **Full Stack applications** using React and Node.js, integrated with **IBM watsonx.ai** for intelligent automation
- Architecting **Micro-frontend** solutions on **Red Hat OpenShift**, enabling independent scaling and deployment for various business units
- Implementing **GraphQL APIs** to unify data access across multiple backend services and legacy databases
- Leading the migration of monolithic web applications to **Serverless architectures**, reducing infrastructure costs by 30%
- Mentoring a team of developers on modern frontend frameworks and **Cloud-Native** development practices

**Senior Full Stack Developer / Technical Lead** | 2020 - 2025  
*Goldman Sachs, Ypsomed, Cushman & Wakefield*

- Led full stack development initiatives across finance, healthcare, and real estate sectors
- Designed and implemented **End-to-End** solutions supporting millions of daily transactions
- Established coding standards and automated testing frameworks to ensure high code quality
...
- Led cross-functional teams designing scalable web applications
- Established frontend frameworks and backend implementation strategies
...
**Immediate Availability** for full stack developer roles
