# RIFAT ERDEM SAHIN
## Dataops Engineer | Technology Specialist
...
Senior Dataops Engineer specializing in **enterprise technology solutions, automation, and system optimization**. Expert in designing and implementing scalable solutions supporting mission-critical business operations.

---

## CORE COMPETENCIES

⚙️ **Dataops Engineer Expertise**
- Enterprise dataops engineer design and implementation
...
**Enterprise Dataops Engineer Platform**
- **Challenge:** Implement scalable dataops engineer solutions for financial services environment
...
- **Challenge:** Scale dataops engineer capabilities for medical device and IoT environments
...
- **Challenge:** Modernize dataops engineer infrastructure for property management analytics
...
**Senior Dataops Engineer / AI Solutions Architect** | January 2025 - Present  
*IBM | London, UK*
...
**Senior Dataops Engineer / Technical Lead** | 2020 - 2025  
*Goldman Sachs, Ypsomed, Cushman & Wakefield*

- Led dataops engineer initiatives across finance, healthcare, and real estate sectors
...
**Immediate Availability** for dataops engineer roles
