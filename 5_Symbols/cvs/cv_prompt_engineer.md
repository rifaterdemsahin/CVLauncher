# RIFAT ERDEM SAHIN
## Prompt Engineer | Technology Specialist
...
Senior Prompt Engineer specializing in **enterprise technology solutions, automation, and system optimization**. Expert in designing and implementing scalable solutions supporting mission-critical business operations.

---

## CORE COMPETENCIES

⚙️ **Prompt Engineer Expertise**
- Enterprise prompt engineer design and implementation
...
**Enterprise Prompt Engineer Platform**
- **Challenge:** Implement scalable prompt engineer solutions for financial services environment
...
- **Challenge:** Scale prompt engineer capabilities for medical device and IoT environments
...
- **Challenge:** Modernize prompt engineer infrastructure for property management analytics
...
**Senior Prompt Engineer / AI Solutions Architect** | January 2025 - Present  
*IBM | London, UK*
...
**Senior Prompt Engineer / Technical Lead** | 2020 - 2025  
*Goldman Sachs, Ypsomed, Cushman & Wakefield*

- Led prompt engineer initiatives across finance, healthcare, and real estate sectors
...
**Immediate Availability** for prompt engineer roles
