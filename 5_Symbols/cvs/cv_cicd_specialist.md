# RIFAT ERDEM SAHIN
## Cicd Specialist | Technology Specialist
...
Senior Cicd Specialist specializing in **enterprise technology solutions, automation, and system optimization**. Expert in designing and implementing scalable solutions supporting mission-critical business operations.

---

## CORE COMPETENCIES

⚙️ **Cicd Specialist Expertise**
- Enterprise cicd specialist design and implementation
...
**Enterprise Cicd Specialist Platform**
- **Challenge:** Implement scalable cicd specialist solutions for financial services environment
...
- **Challenge:** Scale cicd specialist capabilities for medical device and IoT environments
...
- **Challenge:** Modernize cicd specialist infrastructure for property management analytics
...
**Senior Cicd Specialist / AI Solutions Architect** | January 2025 - Present  
*IBM | London, UK*
...
**Senior Cicd Specialist / Technical Lead** | 2020 - 2025  
*Goldman Sachs, Ypsomed, Cushman & Wakefield*

- Led cicd specialist initiatives across finance, healthcare, and real estate sectors
...
**Immediate Availability** for cicd specialist roles
